...
## Scatter Plot of Nuclear Fraction vs CoCLIP:
####################################################################################################################
# Nuclear Mock:
...
plotScatter(Peak_Nuc_M, grouped_annotation,
...
plotScatter(Peak_Nuc_M_mRNA, finalized_annotation,
             log10(NLS_E_M), log10(Nuc_F_M), 
             'log10(NLS CoCLIP)', 'log10(Nuclear Fraction)',
             c(0, 4), c(0, 4), 
...
plotScatter(Peak_Nuc_M_ncRNA, finalized_annotation,
             log10(NLS_E_M), log10(Nuc_F_M), 
             'log10(NLS CoCLIP)', 'log10(Nuclear Fraction)',
             c(0, 4), c(0, 4), 
...
plotScatter(Peak_Nuc_S, grouped_annotation,
...
plotScatter(Peak_Nuc_S_mRNA, finalized_annotation,
             log10(NLS_E_S), log10(Nuc_F_S), 
             'log10(NLS CoCLIP)', 'log10(Nuclear Fraction)',
             c(0, 4), c(0, 4), 
...
plotScatter(Peak_Nuc_S_ncRNA, finalized_annotation,
             log10(NLS_E_S), log10(Nuc_F_S), 
             'log10(NLS CoCLIP)', 'log10(Nuclear Fraction)',
             c(0, 4), c(0, 4), 
...
## Scatter Plot of Cytoplasm Fraction vs CoCLIP:
####################################################################################################################
# Cytoplasm Mock:
...
plotScatter(Peak_Cyt_M, grouped_annotation,
...
plotScatter(Peak_Cyt_M_mRNA, finalized_annotation,
             log10(NES_E_M), log10(Cyto_F_M), 
             'log10(NES CoCLIP)', 'log10(Cytoplasm Fraction)',
             c(0, 4), c(0, 4), 
...
plotScatter(Peak_Cyt_M_ncRNA, finalized_annotation,
             log10(NES_E_M), log10(Cyto_F_M), 
             'log10(NES CoCLIP)', 'log10(Cytoplasm Fraction)',
             c(0, 4), c(0, 4), 
...
plotScatter(Peak_Cyt_S, grouped_annotation, 
...
plotScatter(Peak_Cyt_S_mRNA, finalized_annotation,
             log10(NES_E_S), log10(Cyto_F_S), 
             'log10(NES CoCLIP)', 'log10(Cytoplasm Fraction)',
             c(0, 4), c(0, 4), 
...
plotScatter(Peak_Cyt_S_ncRNA, finalized_annotation,
             log10(NES_E_S), log10(Cyto_F_S), 
             'log10(NES CoCLIP)', 'log10(Cytoplasm Fraction)',
             c(0, 4), c(0, 4), 
...
## Scatter Plot of Nuclear Fold Change Over Input Fraction vs CoCLIP:
####################################################################################################################
x_lim = c(-6, 6)
y_lim = x_lim
...
plotScatter(Peak_Nuc_FC, grouped_annotation,
...
plotScatter(Peak_Nuc_FC_mRNA, finalized_annotation,
             log2(NLS_EvI_M), log2(Nuc_EvI_M),
             'log2(CoCLIP Nuclear/Input)', 'log2(FracCLIP Nuclear/Input)',
             x_lim, y_lim, 
...
plotScatter(Peak_Nuc_FC_ncRNA, finalized_annotation,
             log2(NLS_EvI_M), log2(Nuc_EvI_M),
             'log2(CoCLIP Nuclear/Input)', 'log2(FracCLIP Nuclear/Input)',
             x_lim, y_lim, 
...
## Scatter Plot of Cytoplasm Fold Change Over Input Fraction vs CoCLIP:
####################################################################################################################
x_lim = c(-8, 8)
y_lim = x_lim
...
plotScatter(Peak_Cyt_FC, grouped_annotation,
...
plotScatter(Peak_Cyt_FC_mRNA, finalized_annotation,
             log2(NES_EvI_M), log2(Cyto_EvI_M),
             'log2(CoCLIP Cytoplasm/Input)', 'log2(FracCLIP Cytoplasm/Input)',
             x_lim, y_lim, 
...
plotScatter(Peak_Cyt_FC_ncRNA, finalized_annotation,
             log2(NES_EvI_M), log2(Cyto_EvI_M),
             'log2(CoCLIP Nuclear/Input)', 'log2(FracCLIP Nuclear/Input)',
             x_lim, y_lim, 
